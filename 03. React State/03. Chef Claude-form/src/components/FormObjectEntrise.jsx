function FormObjectEntrise() {
  function signUp(formData) {
    const data = Object.fromEntries(formData);
    const dietaryRestructions = formData.getAll("dietaryRestructions");
    const allData = { ...data, dietaryRestructions };
    console.log(allData);
  }
  ...
  return (
    <>
      ...
      <form action={signUp}>
        ...
        <select name="favColor" id="favColor" defaultValue="orange" required>
...
export default FormObjectEntrise;
